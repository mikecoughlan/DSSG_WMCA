...
def main(config):
	...
	# encoded_df.to_csv(OUTPUT_PATH+'encoded_individual_columns_data.csv', index=False)

	encoded_df = pd.read_csv(OUTPUT_PATH+'encoded_individual_columns_data.csv')
	...
	numeric_df.to_csv(OUTPUT_PATH+'numerical_individual_columns_data.csv', index=False)

	print(numeric_df.columns.unique())
	print(numeric_df['mainheat-description'])
	print(numeric_df['mainheat-description'].unique())
