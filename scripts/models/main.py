...
def main():
	...
	print(combined_df)
	print(combined_df['current-energy-rating'])
	print(combined_df['current-energy-rating'].isnull().sum())
	print(combined_df['current-energy-rating'].unique())
	print(combined_df['mainheat-description'])
	print(combined_df['mainheat-description'].isnull().sum())

	# print('Predicting the Mainheat Random Forest Model and predicting on homes without similarities....')
	# no_sim = RFM.main(sim, no_sim, target='mainheat-description', predicting='mainheat', saved_file_name='all_predictions_homes_without_sim', to_fit=False, file_path=None)
