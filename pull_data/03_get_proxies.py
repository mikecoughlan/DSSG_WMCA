...
class MergeFiles():
    ...
    def load_info(self):
        ...
        PCD_LSOA_MSOA_PATH = self.ROOT_DIR + "/external/ONSUD_AUG_2022_WM.csv"
        ...
        FUEL_POVERTY_PATH = self.ROOT_DIR + "/external/sub-regional-fuel-poverty-2022-tables.xlsx"
        ...
        ENERGY_CONSUMP_PATH = self.ROOT_DIR + "external/LSOA_domestic_elec_2010-20.xlsx"
    ...
    def map_add_info(self, gdf, filename):
        ...
        OUTPUT_DIR = self.ROOT_DIR + 'processed/output/'
    ...
    def encode_var(self, gdf, filename):
        ...
        OUTPUT_DIR = self.ROOT_DIR + 'processed/encoded_proxy/'
        if not os.path.isdir(OUTPUT_DIR):
            os.makedirs(OUTPUT_DIR)
